...
import tw.c3p0cy.practice.book.mastering_microservices_with_java9_2nd.otrs.user.domain.repository.UserRepository;
...
public class UserServiceImpl extends BaseService<User, String> implements UserService {
  ...
  public void add(User user) throws Exception {
    if (userRepository.containsName(user.getName())) {
      throw new Exception(
          String.format("There is already a product with the name - %s", user.getName()));
    }
