...
import tw.c3p0cy.practice.book.mastering_microservices_with_java9_2nd.otrs.booking.domain.repository.BookingRepository;
...
public class BookingServiceImpl extends BaseService<Booking, String> implements BookingService {
  ...
  public void add(Booking booking) throws Exception {
    if (bookingRepository.containsName(booking.getName())) {
      throw new Exception(
          String.format("There is already a product with the name - %s", booking.getName()));
    }
