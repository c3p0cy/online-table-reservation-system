...
public class InMemRestaurantRepository implements RestaurantRepository<Restaurant, String> {
  ...
  public InMemRestaurantRepository() {
    ...
    Restaurant restaurant =
        new Restaurant("Le Meurice", "1", "228 rue de Rivoli, 75001, Paris", null);
    ...
    restaurant = new Restaurant("Alain Ducasse au Plaza Athénée", "4",
        "25 avenue de Montaigne, 75008, Paris", null);
    ...
    restaurant = new Restaurant("Le Bristol", "10",
        "112, rue du Faubourg St Honoré, 8th arrondissement, Paris", null);
