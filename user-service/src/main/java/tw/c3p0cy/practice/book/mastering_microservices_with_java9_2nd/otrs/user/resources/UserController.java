package tw.c3p0cy.practice.book.mastering_microservices_with_java9_2nd.otrs.user.resources;
...
import tw.c3p0cy.practice.book.mastering_microservices_with_java9_2nd.otrs.user.domain.service.UserService;
import tw.c3p0cy.practice.book.mastering_microservices_with_java9_2nd.otrs.user.domain.vo.UserVO;
...
public class UserController {
  ...
  public ResponseEntity<Entity> findById(@PathVariable("id") String id) {
    logger.info(String.format("user-service findById() invoked:{} for {} ",
