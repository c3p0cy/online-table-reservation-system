package tw.c3p0cy.practice.book.mastering_microservices_with_java9_2nd.otrs.booking.resources;
...
import tw.c3p0cy.practice.book.mastering_microservices_with_java9_2nd.otrs.booking.domain.model.entity.Booking;
import tw.c3p0cy.practice.book.mastering_microservices_with_java9_2nd.otrs.booking.domain.model.entity.Entity;
import tw.c3p0cy.practice.book.mastering_microservices_with_java9_2nd.otrs.booking.domain.service.BookingService;
import tw.c3p0cy.practice.book.mastering_microservices_with_java9_2nd.otrs.booking.domain.vo.BookingVO;
...
public class BookingController {
  ...
  /**
   * Fetch bookings with the given id. <code>http://.../v1/bookings/{id}</code> will return booking
   * with given id.
   *
   * @param id
   * @return A non-null, non-empty collection of bookings.
